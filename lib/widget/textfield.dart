...
/// {@tool snippet}
///
/// Creates a [LabelTextFormField] with an [InputDecoration] and validator function.
///
...
class LabelTextFormField extends FormField<String> {
  ...
  LabelTextFormField({
    ...
    String? initialValue,
    FocusNode? focusNode,
    InputDecorationTextField? decoration = const InputDecorationTextField(),
    ...
    MouseCursor? mouseCursor,
        ...
        builder: (FormFieldState<String> field) {
          final _LabelTextFormFieldState state = field as _LabelTextFormFieldState;
  ...
  @override
  FormFieldState<String> createState() => _LabelTextFormFieldState();
}

class _LabelTextFormFieldState extends FormFieldState<String> {
  RestorableTextEditingController? _controller;

  TextEditingController get _effectiveController => _textFormField.controller ?? _controller!.value;

  LabelTextFormField get _textFormField => super.widget as LabelTextFormField;
  ...
  @override
  void didUpdateWidget(LabelTextFormField oldWidget) {
